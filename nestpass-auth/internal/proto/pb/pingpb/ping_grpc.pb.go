...
func (c *pingServiceClient) Ping(ctx context.Context, in *PingData, opts ...grpc.CallOption) (*PingData, error) {
	out := new(PingData)
...
func (UnimplementedPingServiceServer) Ping(context.Context, *PingData) (*PingData, error) {
...
func _PingService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PingServiceServer).Ping(ctx, req.(*PingData))
	}
